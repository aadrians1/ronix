...
ssmItems[6]=["저작권", "ch06s06.htm", ""]	
ssmItems[7]=["의학적 요구사항", "ch06s07.htm",""]
ssmItems[8]=["안전을 위한 주의사항", "ch06s08.htm", ""]	
ssmItems[9]=["빠른 메뉴"] //create header	
ssmItems[10]=["맨위로", "#top", "_self"]
ssmItems[11]=["메인 페이지로", "index.htm", ""] //create two column row
